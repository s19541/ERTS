...
namespace ErtsModel.Migrations
{
    ...
    [Migration("20211210153825_AddedNumberOfGames")]
    partial class AddedNumberOfGames
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ErtsModel.Entities.Lol.LolTournamentPlayer", b =>
                {
                    ...
                    b.Property<int>("ChampionsPlayed")
                        .HasColumnType("integer")
                        .HasComment("ChampionPlayed");

                    b.Property<double?>("DamageShare")
                        .HasColumnType("double precision")
                        .HasComment("DamageShare");

                    b.Property<double?>("GoldPerMinute")
                        .HasColumnType("double precision")
                        .HasComment("GoldPerMinute");

                    b.Property<double?>("KillParticipation")
                        .HasColumnType("double precision")
                        .HasComment("KillParticipation");

                    b.Property<double?>("MinionsPerMinute")
                        .HasColumnType("double precision")
                        .HasComment("MinionsPerMinute");
            ...
            modelBuilder.Entity("ErtsModel.Entities.TournamentTeam", b =>
                {
                    ...
                    b.HasDiscriminator<string>("Discriminator").HasValue("TournamentTeam");
            ...
            modelBuilder.Entity("ErtsModel.Entities.LolTournamentTeam", b =>
                {
                    b.HasBaseType("ErtsModel.Entities.TournamentTeam");
                    ...
                    b.HasDiscriminator().HasValue("LolTournamentTeam");
                });
